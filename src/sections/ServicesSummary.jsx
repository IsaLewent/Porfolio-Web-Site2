...
const ServicesSummary = () => {
  ...
  return (
    <section
      id="all-services"
      className="mt-20 overflow-hidden flex flex-col justify-center items-center font-extralight leading-snug text-center mb-42 contact-text-responsive w-full pr-24"
    >
